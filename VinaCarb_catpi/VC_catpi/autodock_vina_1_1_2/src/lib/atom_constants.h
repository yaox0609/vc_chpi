...
inline sz ad_type_to_el_type(sz t) {
	switch(t) {
		case AD_TYPE_C    : return EL_TYPE_C;
                case AD_TYPE_A    : return EL_TYPE_C;  //Yao restored Amika's commented out line. Get rid of EL_TYPA_A completely. 
		//case AD_TYPE_A    : return EL_TYPE_A; //Amika's original code
...
inline bool xs_catpi_possible(sz t1, sz t2) {
        return ((t1 == XS_TYPE_N_R && (t2 == XS_TYPE_C_A_P || t2 == XS_TYPE_C_A_H)) || ((t1 == XS_TYPE_C_A_P || t1 == XS_TYPE_C_A_H) && t2 == XS_TYPE_N_R));
}

inline bool xs_chpi_possible(sz t1, sz t2) {
	return (((t1 == XS_TYPE_C_H || t1 == XS_TYPE_C_P) && (t2 == XS_TYPE_C_A_H || t2 == XS_TYPE_C_A_P)) || ((t1 == XS_TYPE_C_A_H || t1 == XS_TYPE_C_A_P) && (t2 == XS_TYPE_C_H || t2 == XS_TYPE_C_P)));
}

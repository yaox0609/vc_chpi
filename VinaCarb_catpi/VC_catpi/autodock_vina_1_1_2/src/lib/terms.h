...
#include <iostream>  //temporary, remove after debugging. ---Yao
...
struct terms {
	...
	void add(unsigned e, distance_additive* p) { distance_additive_terms.add(e, p);}// std::cout<<"\t terms.h terms1: "<<e<<"\n";}
	void add(unsigned e, usable* p)            {            usable_terms.add(e, p);}// std::cout<<"\t terms.h terms2: "<<e<<"\n";}
	void add(unsigned e, additive* p)          {          additive_terms.add(e, p);}// std::cout<<"\t terms.h terms3: "<<e<<"\n";}
	void add(unsigned e, intermolecular* p)    {    intermolecular_terms.add(e, p);}// std::cout<<"\t terms.h terms4: "<<e<<"\n";}
	void add(unsigned e, conf_independent* p)  {  conf_independent_terms.add(e, p);}// std::cout<<"\t terms.h terms5: "<<e<<"\n";}
